...
It is challenging to recognzize the subtle differences between the videos where the actors are performing the same type of actions. To address this, **Action Quality Assessment** is a Computer Vision task that proposed to learn how well an action is performed.
