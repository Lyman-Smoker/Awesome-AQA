...
It is challenging to recognize the subtle differences between the videos where the actors are performing the same type of actions. To address this, **Action Quality Assessment** is a Computer Vision task that proposed to learn how well an action is performed.

In this reprository, interetsting papers about AQA is collected to show the development of the AQA community. Also, some papers about similar tasks and potential datasets are listed below. 
...
- AIFit: Automatic 3D Human-Interpretable Feedback Models for Fitness Training **(CVPR 2021)** [[Paper]](https://openaccess.thecvf.com/content/CVPR2021/html/Fieraru_AIFit_Automatic_3D_Human-Interpretable_Feedback_Models_for_Fitness_Training_CVPR_2021_paper.html) [[Project]](https://fit3d.imar.ro/home)
...
- FLAG3D: A 3D Fitness Activity Dataset with Language Instruction **(CVPR 2023)** [[Project]](https://andytang15.github.io/FLAG3D/) [[Paper]](https://arxiv.org/abs/2212.04638)
